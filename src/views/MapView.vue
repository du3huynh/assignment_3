...
const userAppointments = computed(() => {
  return healthStore.appointments.filter(app => app.location && app.location.lat && app.location.lng)
})
...
onMounted(async () => {
  try {
    ...
    if (window.google) {
      ...
      error.value = 'Google Maps API is not loaded. Please check your API key and network connection.'
    }
  } catch (err) {
  ...
  <div class="map-view" aria-label="Map and health locations finder">
    ...
    <div class="search-controls" role="search">
      <div class="input-group mb-3">
        ...
        />
        <small id="locationHelp" class="form-text">Format: latitude,longitude (e.g., -37.8136,144.9631)</small>
      </div>
      ...
      <div class="col-md-6" v-if="selectedPlace">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text" v-if="selectedPlace.rating">Rating: {{ selectedPlace.rating }}/5</p>
